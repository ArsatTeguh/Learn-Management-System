...
function Footer() {
  ...
  const isLogin = pathname === '/auth/signin' || pathname === '/auth/register';

  return (
    <div
      className={`w-full font-medium text-zinc-600 mt-4  lg:items-center lg:justify-between  flex-col lg:flex-row gap-3 lg:gap-0  ${
